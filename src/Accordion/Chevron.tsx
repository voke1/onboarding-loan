...
import redash from "react-native-redash";
...
export default ({ transition }: ChevronProps) => {
  // redash.bInterpolatePath.
  const rotateZ = redash.bInterpolatePath(transition, Math.PI, 0);
  const backgroundColor = redash.interpolateColor(
    transition,
    { r: 82, g: 82, b: 81 },
    { r: 228, g: 86, b: 69 }
